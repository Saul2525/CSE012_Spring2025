...
# Introduction
INTRO = (
    f"After having one of the most vivid nightmares of your life, awoke "
    f"in a cold sweat. Rather than awakening in your bed, you found yourself in a crop circle,\n"
...
# Path Choice
# Again, I just used a switch-case statement to decide whether or not the program will
# randomly choose left or right. Once the program chooses, it will play out that case scenario.
...
# Combat Encounter
# Here, the program will run a loop of you fighting a monster,
# which will end when PLAYER_HEALTH or MONSTER_HEALTH == 0.
LOOP = True
while LOOP is True:
    ...
    # Then, if PLAYER_HEALTH > 0, the monster will attack,
    # either doing 10 or 20 damage if it lands a crit.
    if PLAYER_HEALTH > 0:
    ...
    # If PLAYER_HEALTH <= 0, then it will print "Game Over!",
    # while if MONSTER_HEALTH <= 0, then it will run the Treasure Check.
    if PLAYER_HEALTH <= 0:
        print("Game Over!\n")
        LOOP = False
